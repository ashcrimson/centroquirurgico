    ...
    methods: {
        ...
        async getItems () {
            ...
            try {
                ...
                var res = await axios.get(route('api.examenes.index'));
        ...
        async save () {
            ...
            try {
                ...
                if(this.editedItem.id === 0){
                    ...
                    var res = await axios.post(route('api.examenes.store'),data);

                }else {

                    var res = await axios.patch(route('api.examenes.update',this.editedItem.id),data);
