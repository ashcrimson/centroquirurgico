...
export default {
    ...
    props:{
        ...
        id:{
            type: String,
            default: 'modalSelectContactoTipo'
        },
        disabled:{
            type: Boolean,
            default: false
    ...
    methods: {
        ...
        async getItems () {
            ...
            try {
                ...
                var res = await axios.get(route('api.contacto_tipos.index'));
        ...
        async save () {
            ...
            try {
                ...
                if(this.editedItem.id === 0){
                    ...
                    var res = await axios.post(route('api.contacto_tipos.store'),data);

                }else {

                    var res = await axios.patch(route('api.contacto_tipos.update',this.editedItem.id),data);
