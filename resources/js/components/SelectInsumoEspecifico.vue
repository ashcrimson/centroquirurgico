...
<script>
    ...
    export default {
        ...
        props:{
            ...
            id:{
                type: String,
                default: 'modalSelectInsumoEspecifico'
            },
            disabled:{
                type: Boolean,
                default: false
        ...
        methods: {
            ...
            async getItems () {
                ...
                try {
                    ...
                    var res = await axios.get(route('api.insumo_especificos.index'));
            ...
            async save () {
                ...
                try {
                    ...
                    if(this.editedItem.id === 0){
                        ...
                        var res = await axios.post(route('api.insumo_especificos.store'),data);

                    }else {

                        var res = await axios.patch(route('api.insumo_especificos.update',this.editedItem.id),data);
