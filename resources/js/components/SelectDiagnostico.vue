...
export default {
    ...
    props:{
        ...
        id:{
            type: String,
            default: 'modalSelectDiagnostico'
        },
        disabled:{
            type: Boolean,
            default: false
    ...
    methods: {
        ...
        async getItems () {
            ...
            try {
                ...
                var res = await axios.get(route('api.diagnosticos.index'));
        ...
        async save () {
            ...
            try {
                ...
                if(this.editedItem.id === 0){
                    ...
                    var res = await axios.post(route('api.diagnosticos.store'),data);

                }else {

                    var res = await axios.patch(route('api.diagnosticos.update',this.editedItem.id),data);
