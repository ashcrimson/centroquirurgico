...
<script>
    ...
    export default {
        ...
        props:{
            ...
            id:{
                type: String,
                default: 'modalSelectCirugiaTipo'
            },
            disabled:{
                type: Boolean,
                default: false
            ...
            async save () {
                ...
                try {
                    ...
                    if(this.editedItem.id === 0){
                        ...
                        var res = await axios.post(route('api.cirugia_tipos.store'),data);

                    }else {

                        var res = await axios.patch(route('api.cirugia_tipos.update',this.editedItem.id),data);
