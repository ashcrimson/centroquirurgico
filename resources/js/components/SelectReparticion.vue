        ...
        methods: {
            ...
            async getItems () {
                ...
                try {
                    ...
                    var res = await axios.get(route('api.reparticiones.index'));
            ...
            async save () {
                ...
                try {
                    ...
                    if(this.editedItem.id === 0){
                        ...
                        var res = await axios.post(route('api.reparticiones.store'),data);

                    }else {

                        var res = await axios.patch(route('api.reparticiones.update',this.editedItem.id),data);
