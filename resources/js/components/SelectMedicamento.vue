...
export default {
    ...
    props:{
        ...
        id:{
            type: String,
            default: 'modalSelectMedicamento'
        },
        disabled:{
            type: Boolean,
            default: false
    ...
    methods: {
        ...
        async getItems () {
            ...
            try {
                ...
                var res = await axios.get(route('api.medicamentos.index'));
        ...
        async save () {
            ...
            try {
                ...
                if(this.editedItem.id === 0){
                    ...
                    var res = await axios.post(route('api.medicamentos.store'),data);

                }else {

                    var res = await axios.patch(route('api.medicamentos.update',this.editedItem.id),data);
