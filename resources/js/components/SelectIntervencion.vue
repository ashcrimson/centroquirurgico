            ...
            async save () {
                ...
                try {
                    ...
                    if(this.editedItem.id === 0){
                        ...
                        var res = await axios.post(route('api.intervenciones.store'),data);

                    }else {

                        var res = await axios.patch(route('api.intervenciones.update',this.editedItem.id),data);
