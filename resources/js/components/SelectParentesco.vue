...
<script>
    ...
    export default {
        ...
        props:{
            ...
            id:{
                type: String,
                default: 'modalSelectParentescos'
            },
            disabled:{
                type: Boolean,
                default: false
        ...
        methods: {
            ...
            async getItems () {
                ...
                try {
                    ...
                    var res = await axios.get(route('api.parentescos.index'));
            ...
            async save () {
                ...
                try {
                    ...
                    if(this.editedItem.id === 0){
                        ...
                        var res = await axios.post(route('api.parentescos.store'),data);

                    }else {

                        var res = await axios.patch(route('api.parentescos.update',this.editedItem.id),data);
