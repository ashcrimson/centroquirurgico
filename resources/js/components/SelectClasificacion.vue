            ...
            async save () {
                ...
                try {
                    ...
                    if(this.editedItem.id === 0){
                        ...
                        var res = await axios.post(route('api.clasificaciones.store'),data);

                    }else {

                        var res = await axios.patch(route('api.clasificaciones.update',this.editedItem.id),data);
