        ...
        methods: {
            ...
            async getItems () {
                ...
                try {
                    ...
                    var res = await axios.get(route('api.convenios.index'));
            ...
            async save () {
                ...
                try {
                    ...
                    if(this.editedItem.id === 0){
                        ...
                        var res = await axios.post(route('api.convenios.store'),data);

                    }else {

                        var res = await axios.patch(route('api.convenios.update',this.editedItem.id),data);
