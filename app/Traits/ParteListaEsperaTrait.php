...
trait ParteListaEsperaTrait
{
    ...
    public function validarPreopColor(Parte $parte)
    {
        ...
        if ($parte->control_preop_eu && $parte->control_preop_anestesista && !$parte->control_preop_medico &&
            ...
            if ($parte->pase_preop_eu == "1" && $parte->pase_preop_anestesista == "1" && $parte->pase_preop_medico != "1" &&
                ...
                $attr = '#99E066';
                   ...
                   !$parte->control_banco_sangre) {
            if ($parte->pase_preop_eu == "1" && $parte->pase_preop_medico == "1" && $parte->pase_preop_anestesista != "1" &&
                $parte->pase_banco_sagre != "1") {
                $attr = '#99E066';
            }
        ...
        else if ($parte->control_preop_medico && $parte->control_preop_anestesista  && !$parte->control_preop_eu &&
                   !$parte->control_banco_sangre) {
            if ($parte->pase_preop_medico && $parte->pase_preop_anestesista && !$parte->pase_preop_eu &&
                !$parte->pase_banco_sagre) {
                $attr = '#99E066';
            }
        } else if ($parte->control_preop_medico && $parte->control_banco_sangre  && !$parte->control_preop_eu &&
                   !$parte->control_preop_anestesista) {
            if ($parte->pase_preop_medico && $parte->pase_banco_sagre && !$parte->pase_preop_eu &&
                !$parte->pase_preop_anestesista) {
                $attr = '#99E066';
            }
        }

        else if ($parte->control_preop_anestesista && $parte->control_banco_sangre  && !$parte->control_preop_eu &&
            !$parte->control_preop_medico) {
            if ($parte->pase_preop_anestesista && $parte->pase_banco_sagre && !$parte->pase_preop_eu &&
                !$parte->pase_preop_medico) {
                $attr = '#99E066';
            }
        }
