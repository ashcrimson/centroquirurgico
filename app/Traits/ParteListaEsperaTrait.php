...
trait ParteListaEsperaTrait
{
    ...
    public function validarPreopColor(Parte $parte)
    {
        ...
        if ($parte->control_preop_eu && ($parte->control_preop_anestesista)) {
            if ($parte->pase_preop_eu && ($parte->pase_preop_anestesista)) {
                $attr = '#99E066';
            }
        }

        if ($parte->control_preop_eu && ($parte->control_preop_medico)) {
            if ($parte->pase_preop_eu && ($parte->pase_preop_medico)) {
                $attr = '#99E066';
            }
        }

        if ($parte->control_preop_eu && ($parte->control_banco_sangre)) {
            if ($parte->pase_preop_eu && ($parte->pase_banco_sagre)) {
                $attr = '#99E066';
            }
        }
