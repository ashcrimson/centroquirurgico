...
class ReparticionDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
       ...
       return $dataTable->addColumn('action', function(Reparticion $reparticion){
     ...
     *
     * @param \App\Models\Reparticion $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Reparticion $model)
    {
