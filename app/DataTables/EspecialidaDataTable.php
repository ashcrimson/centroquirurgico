...
class EspecialidaDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
       ...
       return $dataTable->addColumn('action', function(Especialida $especialida){
     ...
     *
     * @param \App\Models\Especialida $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Especialida $model)
    {
