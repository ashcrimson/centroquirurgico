...
class PabellonDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
       ...
       return $dataTable->addColumn('action', function(Pabellon $pabellon){
     ...
     *
     * @param \App\Models\Pabellon $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Pabellon $model)
    {
