...
class ClasificacionDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
       ...
       return $dataTable->addColumn('action', function(Clasificacion $clasificacion){
     ...
     *
     * @param \App\Models\Clasificacion $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Clasificacion $model)
    {
