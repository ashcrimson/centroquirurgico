 ...
 * @property \Illuminate\Database\Eloquent\Collection $especialidadSubs
...
class Especialidad extends Model
{
    ...
    {
        return $this->belongsToMany(\App\Models\GrupoBase::class, 'especialidad_grupo_base', 'especialidad_id', 'grupo_base_id');
    }
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsToMany
     **/
    public function especialidadSubs()
    {
        return $this->belongsToMany(\App\Models\EspecialidadSub::class, 'especialidad_especialidad_sub', 'especialidad_id', 'especialidad_sub_id');
    }
