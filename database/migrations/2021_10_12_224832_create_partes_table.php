...
class CreatePartesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('partes', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('sistemasalud_id')->nullable()->index('fk_partes_sistemasaluds1_idx')->nullable();
            $table->unsignedBigInteger('grupobase_id')->nullable()->index('fk_partes_grupobases1_idx')->nullable();
